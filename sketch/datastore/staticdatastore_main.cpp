...
void printHelper(std::ostream& out, const Tuple& t,
                 std::string const& postfix) {
  out << "\t{\"keyId\":" << size_t(std::get<currentN>(t).keyTag)
      << ",\"key\":" << std::get<currentN>(t).keyStr() << ",\"typename\":"
      << boost::typeindex::type_id<CurrentType>().pretty_name()
...
int main() {
  ...
  std::cout << "hasAntDirection(std::get):"
            << bool(std::get<size_t(KeyTag::AntDirection)>(ds).value) << "\n";
  std::cout << "\nEmpty Store\n";
  ...
  std::cout << "hasAntDirection(getAny):"
            << bool(boost::any_cast<boost::optional<int>>(b)) << newl;
  std::cout << "hasAntDirection(std::get):"
            << bool(std::get<size_t(KeyTag::AntDirection)>(ds).value) << newl;
  std::cout << "hasAntDirection(get):"
            << bool(unsafe::get<boost::optional<int>>(ds, "AntDirection"))
            << newl;
  ...
  std::cout
      << "called: std::get<size_t(KeyTag::AntPos)>(ds).value = boost::none\n";
