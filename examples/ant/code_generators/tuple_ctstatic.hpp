...
public:
  ...
  std::string operator()(ant::move const &) const { return "hana::tuple<tag::Move>"; }
  std::string operator()(ant::left const &) const { return "hana::tuple<tag::Left>"; }
  std::string operator()(ant::right const &) const { return "hana::tuple<tag::Right>"; }
};
...
{{ 
  ...
  return antBoardSim.score(); 
    ...
    "tupleNotation"_a = boost::apply_visitor(
      AsTupletNotation{}, ant)
